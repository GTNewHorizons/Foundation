...
public class S22ConstructorTransformer implements IFoundationTransformer {
    ...
    public void transform(ClassNode cn) {
        ...
        // from the MethodNode, reinserting the super call and return to make it valid, and adding a call to a
        // newConstructor
        // function which is added by MixinS22PacketMultiBlockChange and the interface it applies. The various loads to
        // that
        ...
        for (MethodNode mn : cn.methods) {
            if (mn.name.equals("<init>") && mn.desc.equals("(I[SLnet/minecraft/world/chunk/Chunk;)V")) {
                ...
                instructions
                    .add(new MethodInsnNode(Opcodes.INVOKESPECIAL, "net/minecraft/network/Packet", "<init>", "()V"));
                ...
                instructions.add(
                    new MethodInsnNode(
                        ...
                        "com/gtnewhorizons/foundation/mixins/interfaces/IMixinS22PacketMultiBlockChange",
                        "newConstructor",
